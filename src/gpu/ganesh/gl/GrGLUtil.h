...
static constexpr uint32_t GrGLFormatChannels(GrGLFormat format) {
    switch (format) {
        ...
        case GrGLFormat::kRGBA8:                 return VX_COLOR_CHANNEL_FLAGS_RGBA;
        case GrGLFormat::kR8:                    return VX_COLOR_CHANNEL_FLAG_RED;
        case GrGLFormat::kALPHA8:                return VX_COLOR_CHANNEL_FLAG_ALPHA;
        case GrGLFormat::kLUMINANCE8:            return VX_COLOR_CHANNEL_FLAG_GRAY;
        case GrGLFormat::kLUMINANCE8_ALPHA8:     return VX_COLOR_CHANNEL_FLAGS_GRAY_ALPHA;
        case GrGLFormat::kBGRA8:                 return VX_COLOR_CHANNEL_FLAGS_RGBA;
        case GrGLFormat::kRGB565:                return VX_COLOR_CHANNEL_FLAGS_RGB;
        case GrGLFormat::kRGBA16F:               return VX_COLOR_CHANNEL_FLAGS_RGBA;
        case GrGLFormat::kR16F:                  return VX_COLOR_CHANNEL_FLAG_RED;
        case GrGLFormat::kRGB8:                  return VX_COLOR_CHANNEL_FLAGS_RGB;
        case GrGLFormat::kRGBX8:                 return VX_COLOR_CHANNEL_FLAGS_RGB;
        case GrGLFormat::kRG8:                   return VX_COLOR_CHANNEL_FLAGS_RG;
        case GrGLFormat::kRGB10_A2:              return VX_COLOR_CHANNEL_FLAGS_RGBA;
        case GrGLFormat::kRGBA4:                 return VX_COLOR_CHANNEL_FLAGS_RGBA;
        case GrGLFormat::kSRGB8_ALPHA8:          return VX_COLOR_CHANNEL_FLAGS_RGBA;
        case GrGLFormat::kCOMPRESSED_ETC1_RGB8:  return VX_COLOR_CHANNEL_FLAGS_RGB;
        case GrGLFormat::kCOMPRESSED_RGB8_ETC2:  return VX_COLOR_CHANNEL_FLAGS_RGB;
        case GrGLFormat::kCOMPRESSED_RGB8_BC1:   return VX_COLOR_CHANNEL_FLAGS_RGB;
        case GrGLFormat::kCOMPRESSED_RGBA8_BC1:  return VX_COLOR_CHANNEL_FLAGS_RGBA;
        case GrGLFormat::kR16:                   return VX_COLOR_CHANNEL_FLAG_RED;
        case GrGLFormat::kRG16:                  return VX_COLOR_CHANNEL_FLAGS_RG;
        case GrGLFormat::kRGBA16:                return VX_COLOR_CHANNEL_FLAGS_RGBA;
        case GrGLFormat::kRG16F:                 return VX_COLOR_CHANNEL_FLAGS_RG;
        case GrGLFormat::kLUMINANCE16F:          return VX_COLOR_CHANNEL_FLAG_GRAY;

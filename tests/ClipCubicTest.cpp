...
DEF_TEST(test_fuzz_crbug_698714, reporter) {
    ...
    builder.moveTo(SkBits2Float(0x00000000), SkBits2Float(0x00000000));  // 0,0
    builder.lineTo(SkBits2Float(0x43434343), SkBits2Float(0x43430143));  //195.263f, 195.005f
    builder.lineTo(SkBits2Float(0x43434343), SkBits2Float(0x43434343));  //195.263f, 195.263f
    builder.lineTo(SkBits2Float(0xb5434343), SkBits2Float(0x434300be));  //-7.2741e-07f, 195.003f
    // 195.263f, 195.263f, -1.16387e-05f, 3.58641e-38f, 3.85088e-29f,1.86082e-39f
    builder.cubicTo(SkBits2Float(0x43434343), SkBits2Float(0x43434341),
    ...
    builder.cubicTo(SkBits2Float(0x016037c0), SkBits2Float(0x43434343),
    ...
    builder.cubicTo(SkBits2Float(0x43434344), SkBits2Float(0x43434341),
            SkBits2Float(0xb74343bd), SkBits2Float(0x01434343),
    ...
    builder.cubicTo(SkBits2Float(0xcab33535), SkBits2Float(0x34cacaca),
            SkBits2Float(0x2acacaca), SkBits2Float(0xcacacae3),
            SkBits2Float(0x27481927), SkBits2Float(0x27334805));
    builder.lineTo(SkBits2Float(0xb5434343), SkBits2Float(0x43434343));  //-7.2741e-07f, 195.263f
    // 195.263f, 195.263f, -1.16387e-05f, 195.212f, 195.263f, -2
    builder.cubicTo(SkBits2Float(0x43434343), SkBits2Float(0x43434341),
            SkBits2Float(0xb74343b9), SkBits2Float(0x43433643),
            SkBits2Float(0x43434343), SkBits2Float(0xc0000014));
    builder.lineTo(SkBits2Float(0xc7004343), SkBits2Float(0x27480527));  //-32835.3f, 2.77584e-15f
...
DEF_TEST(cubic_scan_error_crbug_844457_and_845489, reporter) {
    ...
    SkPathBuilder builder;
    builder.moveTo(-30/64.0, -31/64.0);
    builder.cubicTo(-31/64.0, -31/64,-31/64.0, -31/64,-31/64.0, 100);
    ...
    builder.moveTo(-30/64.0f,             -31/64.0f + 1/256.0f);
    builder.cubicTo(-31/64.0f + 1/256.0f, -31/64.0f + 1/256.0f,

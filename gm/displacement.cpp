...
protected:
    ...
    void onDraw(SkCanvas* canvas) override {
        ...
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_G, 0.0f, displ, nullptr));
        this->drawClippedBitmap(canvas, 0, 0, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_B, VX_COLOR_CHANNEL_A, 16.0f, displ, nullptr));
        this->drawClippedBitmap(canvas, 100, 0, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_B, 32.0f, displ, nullptr));
        this->drawClippedBitmap(canvas, 200, 0, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_G, VX_COLOR_CHANNEL_A, 48.0f, displ, nullptr));
        this->drawClippedBitmap(canvas, 300, 0, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_A, 64.0f, displ, nullptr));
        this->drawClippedBitmap(canvas, 400, 0, paint);

        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_G, 40.0f, displ, nullptr));
        this->drawClippedBitmap(canvas, 0, 100, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_B, VX_COLOR_CHANNEL_A, 40.0f, displ, nullptr));
        this->drawClippedBitmap(canvas, 100, 100, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_B, 40.0f, displ, nullptr));
        this->drawClippedBitmap(canvas, 200, 100, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_G, VX_COLOR_CHANNEL_A, 40.0f, displ, nullptr));
        this->drawClippedBitmap(canvas, 300, 100, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_A, 40.0f, displ, nullptr));
        this->drawClippedBitmap(canvas, 400, 100, paint);

        SkIRect cropRect = SkIRect::MakeXYWH(30, 30, 40, 40);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_G, 0.0f, displ, nullptr, &cropRect));
        this->drawClippedBitmap(canvas, 0, 200, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
            VX_COLOR_CHANNEL_B, VX_COLOR_CHANNEL_A, 16.0f, displ, nullptr, &cropRect));
        this->drawClippedBitmap(canvas, 100, 200, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_B, 32.0f, displ, nullptr, &cropRect));
        this->drawClippedBitmap(canvas, 200, 200, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_G, VX_COLOR_CHANNEL_A, 48.0f, displ, nullptr, &cropRect));
        this->drawClippedBitmap(canvas, 300, 200, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_A, 64.0f, displ, nullptr, &cropRect));
        this->drawClippedBitmap(canvas, 400, 200, paint);

        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_G, 40.0f, displ, nullptr, &cropRect));
        this->drawClippedBitmap(canvas, 0, 300, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_B, VX_COLOR_CHANNEL_A, 40.0f, displ, nullptr, &cropRect));
        this->drawClippedBitmap(canvas, 100, 300, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_B, 40.0f, displ, nullptr, &cropRect));
        this->drawClippedBitmap(canvas, 200, 300, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_G, VX_COLOR_CHANNEL_A, 40.0f, displ, nullptr, &cropRect));
        this->drawClippedBitmap(canvas, 300, 300, paint);
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_R, VX_COLOR_CHANNEL_A, 40.0f, displ, nullptr, &cropRect));
        ...
        paint.setImageFilter(SkImageFilters::DisplacementMap(
                VX_COLOR_CHANNEL_G, VX_COLOR_CHANNEL_A, 40.0f, nullptr, nullptr));
